...
using Pixir.Not.Control.Interface.Comun.Extended.Validate;
using Pixir.Not.Control.Control.Comun;
using Pixir.Not.View2.Properties;

#endregion


namespace Pixir.Not.View2.Views.Common.Persona
{
    public partial class frmPersonaManager : Form, ICXFormManager<ComPersona>
    {
        ...
        private void setAgregarComboBoxInitial()
        {
            try
            {
                ...
                {
                    throw new Exception("Estado civil vacio");
                }
                ...
                {
                    throw new Exception("Nacionalidad vacio");
                }
                ...
                {
                    throw new Exception("Ocupacion vacio");
                }
                ...
                {
                    throw new Exception("Regimen matrimonial vacio");
                }
        ...
        private void btnCancelarClick(object sender, EventArgs e)
        {
            try
            {
                ...
                if (this.StateForm == EnumStateForm.WithChanges)
                {
                    ...
                    if (this.tipoOperacion == EnumOperationType.Agregar)
                    {
                        result = MessageBox.Show(Resources.PRE_CIERRE_NUEVO,
                            Resources.MES_TITULO, MessageBoxButtons.YesNoCancel,
                            MessageBoxIcon.Information);
                    }
                    else
                    {
                        result = MessageBox.Show(Resources.PRE_CIERRE_EDITAR,
                            Resources.MES_TITULO, MessageBoxButtons.YesNoCancel,
                            MessageBoxIcon.Information);
                    }
        ...
        private bool validaEntidad()
        {
            try
            {
                ...
                {
                    MessageBox.Show(this, Resources.MES_ENTIDAD_VACIA, Resources.TIT_SISTEMA,
        ...
        private bool validaPersonaDuplicadaInsert()
        {
            ...
            try
            {
                ...
                {
                    MessageBox.Show(this, Resources.MES_CURP_DUPLICADA, Resources.TIT_VERIFICAR, MessageBoxButtons.OK,
                        MessageBoxIcon.Information);
                    this.txtCurp.Focus();
                    return false;
                }
                if (existPersona > (int)Not.Data.Extended.Enum.EnumNumericValue.Cero)
                {
                    for (int i = 0; i < lista.Count; i++)
                    {
                        ...
                        if (lista[i].strCURP.Trim().Equals(String.Empty) && this.txtCurp.Text.Trim().Equals(String.Empty))
                        {
                            ...
                            MessageBox.Show(this, Resources.MES_PERSONA_DUPLICADA_CURPS_VACIOS, Resources.TIT_VERIFICAR, MessageBoxButtons.OK,
                                MessageBoxIcon.Information);
                            this.txtCurp.Focus();
                            return false;
                        }
                        ...
                        if (!lista[i].strCURP.Trim().Equals(String.Empty) && !this.txtCurp.Text.Trim().Equals(String.Empty) && lista[i].strCURP.Trim().Equals(this.txtCurp.Text.Trim()))
                        {
                            ...
                            MessageBox.Show(this, Properties.Resources.MES_PERSONA_DUPLICADA_CURPS_LLENOS, Properties.Resources.TIT_VERIFICAR, MessageBoxButtons.OK,
                                MessageBoxIcon.Information);
                            this.txtCurp.Focus();
                            return false;
                        }
                        ...
                        if (lista[i].strCURP.Trim().Equals(String.Empty) && !this.txtCurp.Text.Trim().Equals(String.Empty))
                        {
                            dialogResult = MessageBox.Show(this, Resources.MES_PERSONA_DUPLICADA_CURP_NUEVA_LLENA, Resources.TIT_VERIFICAR,
                        ...
                        if (!lista[i].strCURP.Trim().Equals(String.Empty) && this.txtCurp.Text.Trim().Equals(String.Empty))
                        {
                            dialogResult = MessageBox.Show(this, Resources.MES_PERSONA_DUPLICADA_CURP_ENBD_LLENA, Resources.TIT_VERIFICAR,
                            MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
                        ...
                        for (int i = 0; i < lista.Count; i++)
                        {
                            if (lista[i].id != this.BaseEntity.id)
                            {
                                ...
                                if (!lista[i].strCURP.Trim().Equals(String.Empty) && !this.txtCurp.Text.Trim().Equals(String.Empty) && lista[i].strCURP.Trim().Equals(this.txtCurp.Text.Trim()))
                                {
                                    ...
                                    MessageBox.Show(this, Resources.MES_PERSONA_DUPLICADA_CURPS_LLENOS, Resources.TIT_VERIFICAR, MessageBoxButtons.OK,
                                        MessageBoxIcon.Information);
                                    this.txtCurp.Focus();
                                    return false;
                                }
        ...
        private bool validateNull()
        {
            try
            {
                ...
                {
                    MessageBox.Show(this, Resources.MES_NOMBRE_VACIO, Resources.TIT_VERIFICAR, MessageBoxButtons.OK,
                        MessageBoxIcon.Error);
                ...
                {
                    MessageBox.Show(this, Resources.MES_APELLIDO_PATERNO_VACIO, Resources.TIT_VERIFICAR, MessageBoxButtons.OK,
                        MessageBoxIcon.Error);
                ...
                {
                    MessageBox.Show(this, Resources.MES_COMBOBOX_SEXO_SIN_SELECCIONAR, Resources.TIT_VERIFICAR, MessageBoxButtons.OK,
                        MessageBoxIcon.Error);
                ...
                {
                    MessageBox.Show(this, Resources.MES_COMBOBOX_ESTADO_CIVIL_SIN_SELECCIONAR, Resources.TIT_VERIFICAR,
                ...
                {
                    MessageBox.Show(this, Resources.MES_COMBOBOX_OCUPACION_SIN_SELECCIONAR, Resources.TIT_VERIFICAR,
                        MessageBoxButtons.OK, MessageBoxIcon.Error);
                ...
                {
                    MessageBox.Show(this, Resources.MES_ORIGINARIO_VACIO, Resources.TIT_VERIFICAR, MessageBoxButtons.OK,
                        MessageBoxIcon.Error);
                ...
                {
                    MessageBox.Show(this, Resources.MES_COMBOBOX_NACIONALIDAD_SIN_SELECCIONAR, Resources.TIT_VERIFICAR,
                        MessageBoxButtons.OK, MessageBoxIcon.Error);
                    this.cmbComCatEstadoCivil.Focus();
                    return false;
                }
        ...
        private bool validateRegularExpresison()
        {
            try
            {
                ...
                if (!this.txtCurp.Text.getTextFieldNull())
                {
                    ...
                    {
                        MessageBox.Show(this, Resources.MES_CURP_INCORRECTA, Resources.TIT_VERIFICAR, MessageBoxButtons.OK,
                            MessageBoxIcon.Error);
                        this.txtCurp.Focus();
                        return false;
                    }
        ...
        /// <summary>
        /// Metodo que activa el chekcbox si la nacionalidad es extranjera
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void cmbComCatNacionalidad_SelectedIndexChanged(object sender, EventArgs e)
        {
            try
            {
                //Si se pulsa en Extranjera activa el chekbox, el valor de selectindex es igual a 2
                if (this.cmbComCatNacionalidad.Text.Equals(Not.Data.Extended.Enum.EnumNationality.EXTRANJERA.ToString()))
                {
                    this.chkDocumentoLegalEstancia.Enabled = true;
                }
                //Si se pulsa en mexicana activa el chekbox, el valor de selectindex es igual a 1
                if (this.cmbComCatNacionalidad.Text.Equals(Not.Data.Extended.Enum.EnumNationality.MEXICANA.ToString()))
                {
                    this.chkDocumentoLegalEstancia.Enabled = false;
                    this.chkDocumentoLegalEstancia.Checked = false;
                }
            }
            catch (Exception _e)
            {
        ...
        /// <summary>
        /// metodo que activa el combobox de regimen matrimonial, si la
        /// selecion es Casado(a)
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void cmbComCatEstadoCivil_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (this.cmbComCatEstadoCivil.Text.Equals(Not.Data.Extended.Enum.EnumStatePerson.CASADO.ToString() + "(A)"))
            {
                this.cmbComCatRegimenMatrimonial.Enabled = true;
            }
            else
            {
                this.cmbComCatRegimenMatrimonial.Enabled = false;
                this.cmbComCatRegimenMatrimonial.SelectedIndex = (int)Not.Data.Extended.Enum.EnumNumericValue.MenosUno;
            }
        }
